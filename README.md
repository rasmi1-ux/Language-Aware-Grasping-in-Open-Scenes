### Note: 
This project was fully developed by Mohammad and me, and the same [*repo*](https://github.com/Re-37/Language-Aware-Grasping-in-Open-Scenes.git) can be found on his account.
